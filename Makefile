...
#    Updated: 2016/05/29 11:14:01 by cledant          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_NAME = ft_debug_map_piece.c main.c ft_lstnewpushback.c ft_lstreadraw_file.c \
		   ft_lstgnl.c \
		   ...
		   ft_env_isolate_piece.c ft_env_setpiecesize.c ft_simple_fill.c
